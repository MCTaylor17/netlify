...
const FAQ = () => (
  <article>
    ...
    <p>We did open source one of the main tools that I developed at BCIT.  It's an MS-Word to HTML conversion tool called Dewordify.  If you're interested, I wrote a <a href="">story of how it came to be</a> and some of the challenges faced in the process.</p>
